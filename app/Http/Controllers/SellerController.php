...
class SellerController extends Controller
{
    ...
    public function profile_modal(Request $request)
    {
     ...
     public function koshkshipingApproved(Request $request)
    {
        //return request();
        $seller = Seller::findOrFail($request->id);
        ...
        $user->koshkshiping = $request->status;
        if($user->save()){
            return 1;
        }
        return 0;
      ...
      public function haveshipingapproved(Request $request)
    {
        //return request();
        $seller = Seller::findOrFail($request->id);
        $seller_id=$seller->user_id;
        ...
        $user->haveshiping = $request->status;
        if($user->save()){
            return 1;
        }
        return 0;
