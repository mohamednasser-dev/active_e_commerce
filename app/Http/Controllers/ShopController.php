...
use App\Models\seller_sellerstype;
    ...
    public function store(Request $request)
    {
        ...
        if(!Auth::check()){
            ...
            if($request->password == $request->password_confirmation){
                ...
                $user->haveshiping = $request->haveshiping;
                $user->password = Hash::make($request->password);
                $user->shipingtype = $request->shipingtype;
                $user->save();

foreach (request('sellerstype') as   $value) 
{

                $seller_sellerstype = new seller_sellerstype;
                $seller_sellerstype->seller_id = $user->id;
                $seller_sellerstype->sellerstype = $value;
                $seller_sellerstype->save();
    ...
    public function update(Request $request, $id)
    {
        // return request();
              ...
              $user->save();
               ...
               seller_sellerstype::where('seller_id',$user_id)->delete();
