...
Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
	...
	Route::resource('sellerstype','sellerstypeController');
	
	Route::get('sellerstypedelet/{id}','sellerstypeController@destroy');
    ...
    Route::post('/sellers/koshkshipingapproved', 'SellerController@koshkshipingApproved')->name('sellers.koshkshipingapproved');
    Route::post('/sellers/haveshipingapproved', 'SellerController@haveshipingapproved')->name('sellers.haveshipingapproved');
