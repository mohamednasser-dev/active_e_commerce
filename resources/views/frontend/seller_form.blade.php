                    ...
                    @if (!Auth::check())
                        <div class="bg-white rounded shadow-sm mb-3">
                            ...
                            <div class="p-3">
                                ...
                                <div class="form-group ">
                                    <label>{{ translate('sellerstypes')}} <span class="text-primary">*</span></label>
<select class="js-example-basic-multiple form-control" name="sellerstype[]" multiple="multiple">
  ...
  <option value="{{$sellerstype->name}}">{{$sellerstype->name}}</option>
   @endforeach
                                  ...
                                  <!--div class="form-group">
                                    <label>{{ translate('do you want koshk shiping')}} <span class="text-primary">*</span></label>
  ...
  <option value="0">{{ translate('no')}}</option>
                                   ...
                                   <div class="form-group">
                                    <label>{{ translate('do you have  shiping')}} <span class="text-primary">*</span></label>
  ...
  <option value="0">{{ translate('no')}}</option>
                                 ...
                                 <div class="form-group">
                                    <label>{{ translate('shiping type')}} <span class="text-primary">*</span></label><br>

<label for="Seller">Seller</label>
<input type="radio" id="Seller" name="shipingtype" value="{{translate('Seller')}}"><br>
