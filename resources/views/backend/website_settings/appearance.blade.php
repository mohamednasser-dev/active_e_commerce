    			...
    			<div class="card-body">
    				<form action="{{ route('business_settings.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-from-label">{{translate('Frontend Website Name')}}</label>
                            <div class="col-sm-10">
    	                ...
    	                <div class="form-group row">
    	                    <label class="col-sm-2 col-from-label">{{translate('Site Motto')}}</label>
                            <div class="col-sm-10">
    					...
    					<div class="form-group row">
    						<label class="col-sm-2 col-from-label">{{ translate('Site Icon') }}</label>
                            <div class="col-sm-10">
    	                ...
    	                <div class="form-group row">
    	                    <label class="col-sm-2 col-from-label">{{translate('Website Base Color')}}</label>
                            <div class="col-sm-10">
    	                ...
    	                <div class="form-group row">
    	                    <label class="col-sm-2 col-from-label">{{translate('Website Base Hover Color')}}</label>
                            <div class="col-sm-10">
